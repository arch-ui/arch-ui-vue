import{w as v,u as f,e as z}from"./index-BflBC_Ux.js";import"./index-hqmhLQ0D.js";import{M as o,Q as w}from"./Button.vue-BkhbgDSa.js";import"./vue.esm-bundler-DWx66a-0.js";const C={title:"Components/Button",tags:["autodocs"],argTypes:{type:{control:{type:"select"},options:["primary","secondary","outline","text"]},status:{control:{type:"select"},options:["default","success","warning","danger","info"]},size:{control:{type:"select"},options:["large","default","small","mini"]},disabled:{control:"boolean"},loading:{control:"boolean"},tag:{control:{type:"select"},options:["button","a","div"]},htmlType:{control:{type:"select"},options:["button","submit","reset"]},icon:{control:{type:"text"}},loadingIcon:{control:{type:"text"}}}},s=t=>`
